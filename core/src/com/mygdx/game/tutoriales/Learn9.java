 ...
 */
public class Learn9 extends BaseScreen {
    ...
    private void buildUI(Locale locale) {
        ...
        TextButton btEnglish = new TextButton("English", Assets.textButtonStyle);
        TextButton btSpanish = new TextButton("Español", Assets.textButtonStyle);
